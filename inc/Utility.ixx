...
export extern "C++" namespace util
{
	...
	[[nodiscard]]
	constexpr long double abs(const long double& value) noexcept
	{
		return 0 < value ? value : -value;
	}
	...
	[[nodiscard]]
	consteval unsigned int sign(const unsigned int&) noexcept
	{
		return 1;
	}
	...
	[[nodiscard]]
	consteval int sign(const unsigned long long&) noexcept
	{
		return 1;
	}
